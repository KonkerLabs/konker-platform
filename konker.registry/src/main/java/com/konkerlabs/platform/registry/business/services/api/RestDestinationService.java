...
public interface RestDestinationService {
	...
	enum Validations {
		GUID_NULL("service.rest_destination.guid.not_null"), DESTINATION_NOT_FOUND(
				"service.rest_destination.not_found"), NAME_IN_USE("service.rest_destination.name.in_use");
