...
public interface DeviceURIDealer {
    ...
    String DEVICE_RULE_URI_TEMPLATE = DEVICE_URI_SCHEME + "://{0}/{1}";

    default URI toDeviceRuleURI(String tenantName, String deviceId) {
        ...
        return URI.create(
            MessageFormat.format(DEVICE_RULE_URI_TEMPLATE,tenantName,deviceId)
        );
    }
}
