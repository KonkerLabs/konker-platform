...
public class DeviceControllerTest extends WebLayerTestContext {
    ...
    public void setUp() {
        ...
        device = Device.builder().deviceId(deviceData.getFirst("deviceId")).name(deviceData.getFirst("name"))
                .description(deviceData.getFirst("description")).build();
    ...
    public void shouldShowDeviceDetails() throws Exception {
        ...
        getMockMvc().perform(get(MessageFormat.format("/devices/{0}", device.getDeviceId())))
                .andExpect(model().attribute("device", device)).andExpect(view().name("devices/show"));
    ...
    public void shouldShowDeviceEventList() throws Exception {
        ...
        getMockMvc().perform(get(MessageFormat.format("/devices/{0}/events", device.getDeviceId())))
                .andExpect(model().attribute("device", device)).andExpect(view().name("devices/events"));
